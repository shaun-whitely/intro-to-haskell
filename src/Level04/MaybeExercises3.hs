-- |
-- These exercises mirror the ones from @MaybeExercises2.hs@. They are for the purpose of teaching
-- the bind operators @=<<@ and @>>=@, and do-notation, which is very useful for working with
-- @Maybe@.
